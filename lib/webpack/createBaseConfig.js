...
module.exports = function createBaseConfig ({
  ...
  const githubSettings = {
    repository: siteConfig.themeConfig.docsRepo,
    branch: siteConfig.themeConfig.docsBranch,
    dir: siteConfig.themeConfig.docsDir
  }

  const { staticFilesExtensionsTest } = siteConfig
  ...
  if (process.env['EMIT_STATISTICS']) {
  ...
  config
    ...
    .use(require('webpack/lib/DefinePlugin'), [{
      ...
      SC_ID: siteConfig.sc ? JSON.stringify(siteConfig.sc) : false,
      SC_SEC: siteConfig.scSec ? JSON.stringify(siteConfig.scSec) : false,
